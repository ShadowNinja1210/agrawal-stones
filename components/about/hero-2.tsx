    ...
    <>
      <section className="md:px-24 lg:flex block justify-between sm:px-16 px-10 py-6">
        ...
        <p className=" first-letter:text-7xl text-justify text-lg pt-8">
          ...
          we are committed to continuous innovation and contemporary design, ensuring our products remain at the
          forefront of industry standards. Our enhanced products and services have helped us cultivate a vast and loyal
          clientele, further solidifying our reputation. Each product is crafted with meticulous attention to detail,
          aligning with modern trends and evolving customer preferences. Experience the unparalleled quality and service
          that set <strong>Agrawal Stones Group</strong> apart in the stone industry, and discover why our customers
          consider us their trusted partner for all their stone needs.
        </p>
      </section>

      <section
        className=" flex flex-col gap-8 p-16 pt-0
       justify-center items-center"
      >
        <h1 className={cn("text-6xl text-center font-bold text-primary-2", cormorantGaramond.className)}>
          One of Our Manufacturing Units
        </h1>
        <hr className="w-10/12 border-neutral-400 mt-4" />
        <Image src="/assets/manufacturing-unit.png" alt="Manufacturing Unit" width={800} height={800} />
      </section>
    </>
  );
}
